...
#ifndef YFramework_YUtils_Macros_h
#define YFramework_YUtils_Macros_h
...
#define SArray(array) (nil == array? @[@""]:array)
#define D2IStr(ddata) ([NSString stringWithFormat:@"%ld",(long)(ddata)])

#define COLOR_454545                [UIColor colorWithRed:69.0/255.0 green:69.0/255.0 blue:69.0/255.0 alpha:1.0]
