...
NSString *const MJRefreshHeaderStateIdleText = @"下拉即可刷新";
NSString *const MJRefreshHeaderStatePullingText = @"松开即可刷新";
...
NSString *const MJRefreshFooterStateNoMoreDataText = @"无更多内容";