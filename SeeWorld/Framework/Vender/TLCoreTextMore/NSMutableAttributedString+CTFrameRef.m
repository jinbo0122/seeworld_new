...
static BOOL CTRunContainsCharactersFromStringRange(CTRunRef run, NSRange range) {
...
//
//static BOOL CTLineContainsCharactersFromStringRange(CTLineRef line, NSRange range) {
...
static CGRect CTRunGetTypographicBoundsAsRect(CTRunRef run, CTLineRef line, CGPoint lineOrigin) {
    CGFloat ascent = 0.0f;
